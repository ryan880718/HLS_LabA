...
// ==============================================================
#ifndef __cordiccart2pol_fpeOg__HH__
#define __cordiccart2pol_fpeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordiccart2pol_fpeOg) {
    ...
    SC_CTOR(cordiccart2pol_fpeOg):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
