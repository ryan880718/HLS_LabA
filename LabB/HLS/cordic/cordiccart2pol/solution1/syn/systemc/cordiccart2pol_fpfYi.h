...
// ==============================================================
#ifndef __cordiccart2pol_fpfYi__HH__
#define __cordiccart2pol_fpfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordiccart2pol_fpfYi) {
    ...
    SC_CTOR(cordiccart2pol_fpfYi):  ACMP_fpext_U ("ACMP_fpext_U") {
