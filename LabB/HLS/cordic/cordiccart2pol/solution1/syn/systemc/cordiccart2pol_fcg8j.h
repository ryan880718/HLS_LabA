...
// ==============================================================
#ifndef __cordiccart2pol_fcg8j__HH__
#define __cordiccart2pol_fcg8j__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordiccart2pol_fcg8j) {
    ...
    SC_CTOR(cordiccart2pol_fcg8j):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
