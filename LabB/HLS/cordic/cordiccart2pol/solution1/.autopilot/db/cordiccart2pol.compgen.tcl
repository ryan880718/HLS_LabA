...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_r \
    op interface \
    ports { r { O 32 vector } r_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_theta \
    op interface \
    ports { theta { O 32 vector } theta_ap_vld { O 1 bit } } \
} "
}
