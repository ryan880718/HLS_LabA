...
reg   [3:0] k_0_reg_307;
wire   [7:0] zext_ln48_1_fu_326_p1;
reg   [7:0] zext_ln48_1_reg_522;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        src1_addr_reg_532 <= zext_ln48_fu_330_p1;
        src2_addr_reg_537 <= zext_ln48_fu_330_p1;
        src3_addr_reg_542 <= zext_ln48_fu_330_p1;
        src4_addr_reg_547 <= zext_ln48_fu_330_p1;
        src5_addr_reg_552 <= zext_ln48_fu_330_p1;
        src6_addr_reg_557 <= zext_ln48_fu_330_p1;
        src7_addr_reg_562 <= zext_ln48_fu_330_p1;
        src_addr_reg_527 <= zext_ln48_fu_330_p1;
        zext_ln48_1_reg_522[6 : 3] <= zext_ln48_1_fu_326_p1[6 : 3];
    end
end
...
assign add_ln63_8_fu_370_p2 = (zext_ln48_1_reg_522 + zext_ln63_fu_366_p1);
...
assign grp_fu_490_p00 = dct_coeff_table_0_lo_reg_621;
...
assign tmp_7_fu_318_p3 = {{dst_offset}, {3'd0}};

assign zext_ln48_1_fu_326_p1 = tmp_7_fu_318_p3;

assign zext_ln48_fu_330_p1 = src_offset;
...
always @ (posedge ap_clk) begin
    zext_ln48_1_reg_522[2:0] <= 3'b000;
    zext_ln48_1_reg_522[7] <= 1'b0;
end
