...
wire   [28:0] trunc_ln57_fu_246_p1;
wire   [28:0] add_ln63_fu_250_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln57_reg_304 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln55_fu_164_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        dst_addr_reg_299 <= zext_ln63_1_fu_197_p1;
        zext_ln63_reg_294[6 : 3] <= zext_ln63_fu_188_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        zext_ln48_reg_280[6 : 3] <= zext_ln48_fu_160_p1[6 : 3];
        zext_ln61_reg_275[6 : 3] <= zext_ln61_fu_148_p1[6 : 3];
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((icmp_ln57_fu_202_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((icmp_ln57_fu_202_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln60_fu_218_p2 = (zext_ln63_reg_294 + zext_ln60_1_fu_214_p1);

assign add_ln61_fu_228_p2 = (zext_ln48_reg_280 + zext_ln60_1_fu_214_p1);

assign add_ln63_1_fu_192_p2 = (zext_ln60_fu_176_p1 + zext_ln61_reg_275);

assign add_ln63_fu_250_p2 = (29'd4096 + trunc_ln57_fu_246_p1);
...
assign dst_d0 = {{add_ln63_fu_250_p2[28:13]}};
...
assign trunc_ln57_fu_246_p1 = tmp_0_reg_128[28:0];
...
always @ (posedge ap_clk) begin
    zext_ln61_reg_275[2:0] <= 3'b000;
    zext_ln61_reg_275[7] <= 1'b0;
    zext_ln48_reg_280[2:0] <= 3'b000;
    zext_ln48_reg_280[7] <= 1'b0;
    zext_ln63_reg_294[2:0] <= 3'b000;
    zext_ln63_reg_294[7] <= 1'b0;
end
